...
import { exerciseReducerOther } from '@workout/excercise-lib/data-access';
...
@NgModule({
  imports: [
    ...
    ExcerciseLibExerciseFeaturesModule,
  ],
  declarations: [
    LoginComponent,
    LoginFormComponent,
  ...
  exports: [NavBarComponent, FooterComponent, FirebaseModule, LayoutComponent],
})
